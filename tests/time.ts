...
type DurationValue = number | string | number[] | Uint8Array | Buffer | BN

const duration = {
    seconds: function (val: DurationValue) { return new BN(val); },
    minutes: function (val: DurationValue) { return new BN(val).mul(this.seconds('60')); },
    hours: function (val: DurationValue) { return new BN(val).mul(this.minutes('60')); },
    days: function (val: DurationValue) { return new BN(val).mul(this.hours('24')); },
    weeks: function (val: DurationValue) { return new BN(val).mul(this.days('7')); },
    years: function (val: DurationValue) { return new BN(val).mul(this.days('365')); },
};
